...
// const bottlesOfBeer = function (bottleQty) {
//   const originalQty = bottleQty;
//   while (bottleQty < 0) {
//     if (bottleQty > 1) {
//       console.log(`${ bottleQty } bottles of beer on the wall, ${ bottleQty } bottles of beer.`);
//       bottleQty --;
//       console.log(`Take one down, pass it around, ${ bottleQty } bottles of beer on the wall...`);
//     } else if (bottleQty === 1) {
//       console.log(`${ bottleQty } bottles of beer on the wall, ${ bottleQty } bottles of beer.`);
//       bottleQty --;
...
//       console.log(`Go to the store and buy some more, ${ originalQty } bottles of beer on the wall.`);
//     }
//   }
// };
//
...
const bottlesOfBeer = function (bottleQty) {
  ...
  while (bottleQty > 0) {
    console.log(`${ bottleQty } bottle of beer on the wall, ${ bottleQty } bottle of beer.`);
    bottleQty --;
    console.log(`Take one down, pass it around, no more bottles of beer on the wall...`);
  }
  while (bottleQty === 0) {
...
const bottlesOfBeer = function (num) {
  for (let i = num; i >= 0; i--) {
    if (i === 0) {
      ...
      console.log(`take one down ${i - 1} bottles of beer on the wall`);
    }
  }
}
...
const beer = {
  ...
  action: function (num) {
    if (num === 0) {
      return 'Go to the stor and buy some more';
    } else if (num === 1) {
      return 'Take one down pass it round';
    }
  },
